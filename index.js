const contentLetterSrart_actived = "HAPPY BIRTHDAY MY SISTER." //Lời mở đầu cho bức thư
const mainContentLetter = "HÔM NAY LÀ NGÀY 20-10 LÀ NGÀY PHỤ NỮ VIỆT NAM CŨNG LÀ NGÀY SINH NHẬT CHỊ .NGÀY SINH NHẬT CHỊ CŨNG LÀ TRÒN 190 NGÀY EM BIẾT CHỊ ,EM XIN CHÚC CHỊ TUỔI MỚI CÓ NHỮNG THÀNH CÔNG MỚI,MUỐN GÌ ĐƯỢC ĐÓ ,CHỊ CŨNG PHẢI LUÔN VUI TƯƠI NHÓ VÌ CÓ EM VÀ HYUK LUÔN LUÔN Ở CẠNH CHỊ MÀ .TỚI ĐÂY THÌ EM BÍ VĂN RỒI NÊN EM XIN TỔNG KẾT LẠI .CHÚC CHỊ TẤT CẢ TRỪ VẤT VẢ NHA." //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/HINH1.png";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/HINH2.JPG"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
